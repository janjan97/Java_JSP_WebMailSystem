<%-- 
    Document   : delete_user_search_result.jsp
    Author     : gsh & lsj
--%>
...
<html>
    ...
    <body>
        ...
        <div id="sidebar">
            ...
            <jsp:include page="sidebar_deluser_previous_menu.jsp" />
        </div>
        ...
        <div id="main">
            ...
            <form name = "AdminDeleteServlet" action ="AdminDeleteServlet.do" method="POST">
                <c:catch var = "errorReason">
                    <mytags:deluser_search_result dataSource="jdbc/JamesWebmail" schema="ood" table="users"/>
                </c:catch>
